...
This lab simulates a real-world scenario where an attacker is brute-forcing login credentials against a web application’s admin portal. The goal is to use Splunk to identify the attack source, determine if the attack succeeded, and document the investigative process.
...
![425 Events Query](./screenshots/1.png)
